...
- Name: pages.spec.ts >> 学习路径页 >> 显示当前阶段标记
- Location: test\pages.spec.ts:226:7
...
Locator: getByText('当前')
Expected: visible
Error: strict mode violation: getByText('当前') resolved to 7 elements:
    1) <p class="mt-1 text-micro leading-5 text-muted">优先补齐当前卡点，再推进下一阶段。</p> aka getByText('优先补齐当前卡点，再推进下一阶段。')
    2) <span>当前路径</span> aka getByText('当前路径')
    3) <p class="mt-2 max-w-[760px] text-body leading-7 text-muted">路径会根据画像、掌握度和练习结果动态调整。当前优先补弱，再推进目标节点。</p> aka getByText('路径会根据画像、掌握度和练习结果动态调整。当前优先补弱，再推进目标节点。')
    4) <span class="mt-0.5 block text-micro text-muted">当前节点</span> aka getByText('当前节点')
    5) <span class="inline-flex items-center gap-1.5 rounded-md px-2.5 py-1.5 text-micro font-bold whitespace-nowrap bg-blue-light text-blue">当前建议</span> aka getByText('当前建议')
    6) <p class="text-micro leading-5 text-muted">因为你当前基础较弱，建议先从这份资源开始补强。</p> aka getByText('因为你当前基础较弱，建议先从这份资源开始补强。')
    7) <p class="text-micro leading-5 text-muted">基于你当前学习阶段，这份资源是更合适的下一步。</p> aka getByText('基于你当前学习阶段，这份资源是更合适的下一步。')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('当前')
      ...
      - generic [ref=e124]:
        ...
        - generic [ref=e151]:
          ...
          - generic [ref=e234]:
            ...
            - paragraph [ref=e237]: 建议先学习短讲义，再通过达标题验证掌握情况。
            - generic [ref=e239]:
              - generic [ref=e240]: 掌握度
              - generic [ref=e241]: 75%
            - generic [ref=e244]:
              - generic [ref=e245]:
                - generic [ref=e246]: 回顾概念讲义
                - img [ref=e247]
              - generic [ref=e249]:
                - generic [ref=e250]: 完成达标练习
                - img [ref=e251]
              - generic [ref=e253]:
                - generic [ref=e254]: 生成代码案例
                - img [ref=e255]
            - generic [ref=e257]:
