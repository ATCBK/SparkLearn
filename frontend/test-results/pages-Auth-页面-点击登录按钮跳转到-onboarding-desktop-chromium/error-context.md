...
- Name: pages.spec.ts >> Auth 页面 >> 点击登录按钮跳转到 onboarding
- Location: test\pages.spec.ts:34:7
...
Received string:  "http://127.0.0.1:3000/auth"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    14 × unexpected value "http://127.0.0.1:3000/auth"
  ...
  - main [ref=e2]:
    ...
    - generic [ref=e8]:
      - generic [ref=e9]:
        ...
        - paragraph [ref=e12]:
          - text: 多智能体协作驱动，实时分析学习行为，动态调整路径节奏，让每一步都恰到好处。
          - generic [ref=e13]: "|"
        - generic [ref=e14]:
          - article [ref=e15]:
            - img [ref=e17]
      ...
      - complementary [ref=e48]:
        ...
        - generic [ref=e54]:
          ...
          - button "立即登录" [active] [ref=e68] [cursor=pointer]
        - generic [ref=e69]:
          - img [ref=e70]
          - generic [ref=e72]:
            - text: 登录即表示同意
