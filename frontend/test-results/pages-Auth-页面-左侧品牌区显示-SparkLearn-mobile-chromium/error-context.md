...
- Name: pages.spec.ts >> Auth 页面 >> 左侧品牌区显示 SparkLearn
- Location: test\pages.spec.ts:29:7
...
Locator: getByText('AI 驱动的个性化学习平台')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('AI 驱动的个性化学习平台')
  ...
  - main [ref=e2]:
    ...
    - generic [ref=e8]:
      - generic [ref=e9]:
        ...
        - paragraph [ref=e12]:
          - text: 基于你的目标、基础与学习偏好，智能规划专属学习路径，精准推荐资源，陪伴你高
          - generic [ref=e13]: "|"
        - generic [ref=e14]:
          - article [ref=e15]:
            - img [ref=e17]
