...
- Name: pages.spec.ts >> Auth 页面 >> 显示登录和注册 Tab
- Location: test\pages.spec.ts:11:7
...
Locator: locator('div.flex.gap-1.bg-bg-hover').getByRole('button', { name: '登录' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('div.flex.gap-1.bg-bg-hover').getByRole('button', { name: '登录' })
  ...
  - main [ref=e2]:
    ...
    - generic [ref=e8]:
      - generic [ref=e9]:
        ...
        - paragraph [ref=e12]:
          - text: 基于你的目标、基础与学习偏好，智能规划专属学习路径，精准推荐资源，陪伴你高效成长。
          - generic [ref=e13]: "|"
        - generic [ref=e14]:
          - article [ref=e15]:
            - img [ref=e17]
