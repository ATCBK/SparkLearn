...
- Name: pages.spec.ts >> Onboarding 页面 (/onboarding) >> 第一步显示"学习目标"标题
- Location: test\pages.spec.ts:116:7
...
```ts
  17  |     await expect(page.getByPlaceholder('请再次输入密码')).toBeVisible()
  18  |     await expect(page.locator('form button[type="submit"]')).toContainText('注册')
  19  |   })
  20  | 
