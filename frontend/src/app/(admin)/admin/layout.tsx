...
export default function AdminShellLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-bg">
      <aside className="fixed left-0 top-0 z-20 flex h-screen w-[244px] flex-col border-r border-[#e8edf5] bg-white">
      ...
      <main
        className="ml-[244px] min-h-screen flex-1"
        style={{
      ...
      >
        <header className="sticky top-0 z-10 flex h-14 items-center justify-between border-b border-[#e8edf5] bg-white/96 px-8 backdrop-blur">
          ...
          <div className="flex items-center gap-2">
            <span className="inline-flex h-8 items-center gap-2 rounded-lg bg-[#f8fafc] px-3 text-xs font-bold text-[#52627b] ring-1 ring-[#e5eaf2]">
            ...
            <span className="text-sm font-semibold text-ink">管理员</span>
          </div>
        </header>
