...
import { api, Message, TutorConversation, TutorFile, TutorRole } from '@/lib/api'
...
export default function TutorPage() {
  ...
  async function handleSend() {
    if ((!input.trim() && pendingFiles.length === 0) || streaming || !currentConversationId) return

    const userInput = input.trim() || '（空文本）'
